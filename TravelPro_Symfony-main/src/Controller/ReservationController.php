...
final class ReservationController extends AbstractController
{
    ...
    public function new(SessionInterface $session,Request $request, EntityManagerInterface $entityManager, EmailService $emailService): Response
    {
    ...
    public function clientReservations(SessionInterface $session,ReservationRepository $reservationRepository, EntityManagerInterface $entityManager): Response
    {
    ...
    public function downloadPdf(SessionInterface $session,$id_reservation, EntityManagerInterface $entityManager): Response
    {
        $reservation = $entityManager->getRepository(Reservation::class)->findOneBy(['id_reservation' => $id_reservation]);
        $clientId = $session->get('client_id');
        if (!$reservation) {
